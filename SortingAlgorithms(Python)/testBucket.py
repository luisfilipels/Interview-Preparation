...
for lista in listas:
    casoTempo.append(
        timeit.timeit("aux={}\naux = bucketSort(aux)".format(list(lista).copy()), setup,
                      number=1))
...
desenhaTresGraficos(passoMelhor, tempoMelhor, passoPior, tempoPior, passo, tempo, x1="Tempo", y1="Elementos", titulo="bucket Sort")